                ...
                <motion.div
                  ...
                  className={\`aspect-square rounded-lg border flex flex-col items-center justify-center p-0.5 cursor-pointer transition-all relative overflow-hidden \${
                    isWinner 
                      ...
                      : 'bg-zinc-200 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 opacity-80'
                  }\`}
                >
                  <span className={\`text-[11px] font-black font-mono leading-none z-10 \${item.isSelf ? 'text-white' : 'text-zinc-600 dark:text-zinc-400'}\`}>{num}</span>
                  <div className={\`flex items-center justify-center mt-0.5 z-10\`}>
                    {item.isSelf ? (
                      ...
                      <Lock className="w-2 h-2 shrink-0 text-zinc-500 dark:text-zinc-500" />
                    )}
                  </div>
                </motion.div>
              );
