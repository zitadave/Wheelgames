                ...
                <motion.div
                  ...
                  className={\`aspect-square rounded-lg border flex flex-col items-center justify-center p-0.5 cursor-pointer transition-all relative overflow-hidden \${
                    isWinner 
                      ...
                      : 'bg-gray-200 dark:bg-[#1c2438] border-gray-300 dark:border-[#2a3655] opacity-80'
                  }\`}
                >
                  <span className={\`text-[11px] font-black font-mono leading-none z-10 \${item.isSelf ? 'text-white' : 'text-gray-500 dark:text-gray-400'}\`}>{num}</span>
                  <div className={\`flex items-center justify-center mt-0.5 z-10 \${item.isSelf ? '' : 'opacity-80'}\`}>
                    {item.isSelf ? (
                      ...
                      <Lock className="w-2 h-2 shrink-0 text-gray-400 dark:text-gray-500" />
                    )}
                  </div>
                </motion.div>
              );
